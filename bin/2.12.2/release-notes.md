...
| **Overnight soak on 2344, in mode 2** | **PASS** — 2026-09-24 22:40 to 2026-09-25 11:00, unattended: **12.82 h, 28 judged strokes**, `stall_faults 0`, `early_stops 0`, `rejected_rate 0`, `err_comm 0`, `mode_changes 0`, `not_reached 0`, `orphan_aborts 0`, gate settled at `position`, no reboot. All 12 scripted stroke sessions ran, none skipped, none failed. The card held its steady state throughout: `on_card 38` and **38 listed**, 30 of this unit's plus the other module's 8, with `current` naming the active file. Heap floor did not move once in 12.8 h (14 KB at the start, 14 KB at the end; free 66 KB, largest block 29 KB). On the bus the real encoder at addr 40 took 9 699 reads with zero errors of any kind |
