...
| Fitting a window position sensor (M3) | [design/windowPositionSensorRequirements.MD](design/windowPositionSensorRequirements.MD) — **study.** M3 is a 40 m hanging flap on ropes (§1.4); absolute + ≥1 Hz + measured at the flap are the requirements that decide a purchase; a threshold interrupt is ruled out on this PCB |
