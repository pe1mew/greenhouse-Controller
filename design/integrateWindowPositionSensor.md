...
> | clean aperture data over a sustained period | **PARTLY, and materially stronger as of 2026-09-15.** **Two clean traverses in both directions**: an OPEN ramp (45 samples, full 0 -> 15 000, 0 rejected) and a CLOSE ramp (98 accepted samples, 7 989 -> 122 monotonic, 0 rejected). **All three acceptance tests now pass** — AT-WP06 (2026-09-12), and AT-WP09 and AT-WP07 on 2026-09-15. What remains for *sustained* is **elapsed time alone**: two traverses in one evening is not a period, and the rig has since had its encoder unplugged and replugged repeatedly. **A quiet soak with the sensor fitted and the gate in POSITION is the only outstanding item on this prerequisite.** |
>
