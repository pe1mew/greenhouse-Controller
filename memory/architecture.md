...
| T6 | `climate_control` | Mode + setpoint logic; consumes T4 notifications. **Its decision law moves behind `drivers/ventModel/` in 2.11.0** (contract: `design/ventModelContract.md`); until then the law exists twice — inline here and as the tested reference `vent_model_stepped` |
