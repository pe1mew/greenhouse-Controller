 ...
 * @brief Forces compilation of keypad_matrix.cpp in the native (host) test build.
 *
 ...
 * It is excluded from the exported library by library.json's srcFilter
 * (this directory is not src/).
 */

#ifdef UNIT_TEST
  #include "../src/keypad_matrix.cpp"
#endif
