...
| The swing (NS-10) | **Narrowed and located.** The sensor delay (modelled) and a fitted north-wind term make the swing right on days without north wind. Left: north-wind days, 3.0-3.2 against 3.9 °C. Next model step: a term at the sensor for the incoming air that reaches it in north wind. Test it against the indoor LoRa sensors before adopting it. The timestamp noise before 2.1.3 is ruled out | The swing is what a linear law sets out to damp |
