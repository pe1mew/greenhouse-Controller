...
| The law over time | `graded_walkthrough.py` | What `graded` does to M1, M2 and M3 as the temperature moves: the step ladder, M3's aperture map, and a synthetic morning driven through the law and the emulated firmware. Prints the two tables in [`gradedCandidate.md`](gradedCandidate.md), "How it behaves over time" |
