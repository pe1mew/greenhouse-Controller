...
> | clean aperture data over a sustained period | **PARTLY.** The **monotonic ramp is demonstrated** (2026-09-15, 45 samples, full 0 -> 15 000 span, 0 rejected) — see Phase 3's exit table. What is still missing is *sustained*: one clean traverse is not a period, and **AT-WP07 and AT-WP09 remain unrun**. Both harnesses exist (`bin/at_wp07.py`, `bin/at_wp09.py`), and both need physical access — a detached draw-wire or obstructed leaf for WP09, a disconnected encoder plus a wind trigger for WP07. |
>
