 ...
 * four"; that was never true of the bitmask and was never exercised. All five
 * is `=31`.
 *
...
#    error "WPOS_FAILFIRST_212 is defined but restores nothing: pass a mask, =1..31"
#  endif
#  if (WPOS_FAILFIRST_212 + 0) > 31
#    error "WPOS_FAILFIRST_212 has bits above 16 that restore nothing: =1..31"
#  endif
#else
#  define FF212 0u
#endif
